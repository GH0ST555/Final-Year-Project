  ...
  return (
    ...
    <div>
      ...
      {gridData && (        <div className='popups'>
                    ...
                    close => (
                        <div className='modal'>
                            <div>
                                ...
                                <button onClick= {() => {close(); setSelectedNodes([]); setSelectedLinks([]); setGenerateSG(false);}}> Clear </button>
            ...
            <Dropdown options={MMoperation} style={{margin: "10px"}} onChange={({ value }) => setSelectedMMop(value)} value={defaultMMOpertaion} placeholder="Select MM Operation" />
